...
def get_net_optim(opts):
    ...
    optimizer = optim.SGD(
        [
            {'params': net.res_feature.parameters(), 'lr': opts.lr * 0.1, 'init_lr': opts.lr * 0.1}, 
            {'params': net.fc1.parameters(), 'lr': opts.lr, 'init_lr': opts.lr}, 
            {'params': net.fc2.parameters(), 'lr': opts.lr, 'init_lr': opts.lr}
...
class Full_net(BaseFeatureExtractor):
    def __init__(self, pre_train=True, out_dim = 12):
        ...
        self.threshold, self.temp = 0.0, 0.1
    ...
    def update_threshold(self, threshold):
        self.threshold = 0.9 * self.threshold + 0.1 * threshold

    def get_weight(self):
        return self.fc2.weight.detach().clone()
